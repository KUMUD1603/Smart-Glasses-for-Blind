...
while True:
    ...
    for(i,c) in enumerate(CounterShape):     
         ...
         #cv2.putText(frame1, "object"+str(counter), (x,y-20), cv2.FONT_HERSHEY_TRIPLEX, 1, (255,244,0),2) 
         ...
         for (x,y) in detect:
             if y<(count_line_position+offset)   and y>(count_line_position-offset):
                 ...
                 detect.remove((x,y))
                 print("object count:"+str(counter))
                 
                 
                    
             cv2.putText(frame1,"OBJECT COUNT:"+str(counter),(450,70),cv2.FONT_HERSHEY_SIMPLEX,2,(0,0,255),5)
